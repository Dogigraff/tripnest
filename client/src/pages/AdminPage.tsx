                ...
                <div className="p-6 space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder='https://auth.example.com/application/o/tripnest/.well-known/openid-configuration'
                      className="w-full px-3 py-2 border border-slate-300 rounded-lg text-sm focus:ring-2 focus:ring-slate-400 focus:border-transparent"
                    />
                  ...
                  {(smtpValues.notification_channel || 'none') === 'email' && (
                    <div className="space-y-3 pt-2 border-t border-slate-100">
                      ...
                      {smtpLoaded && [
                        ...
                        { key: 'smtp_user', label: 'SMTP User', placeholder: 'tripnest@example.com' },
                        { key: 'smtp_pass', label: 'SMTP Password', placeholder: '••••••••', type: 'password' },
                        { key: 'smtp_from', label: 'From Address', placeholder: 'tripnest@example.com' },
                      ].map(field => (
                        <div key={field.key}>
                    ...
                    <div className="space-y-3 pt-2 border-t border-slate-100">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-3 py-2 border border-slate-300 rounded-lg text-sm focus:ring-2 focus:ring-slate-400 focus:border-transparent"
                        />
                        <p className="text-[10px] text-slate-400 mt-1">TripNest will POST JSON with event, title, body, and timestamp to this URL.</p>
                      </div>
                    </div>
                  )}
        ...
        >
          ...
          >
            ...
            <div style={{ padding: '20px 24px' }}>
              ...
              >
{`docker pull tripnest/tripnest:latest
docker stop tripnest && docker rm tripnest
docker run -d --name tripnest \\
  -p 3000:3000 \\
  -v /opt/tripnest/data:/app/data \\
  -v /opt/tripnest/uploads:/app/uploads \\
  --restart unless-stopped \\
  tripnest/tripnest:latest`}
              </div>
