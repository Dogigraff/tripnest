const cs: Record<string, string | { name: string; category: string }[]> = {
  ...
  'login.createAdminHint': 'Nastavte první administrátorský účet pro TripNest.',
  ...
  'admin.addons.subtitle': 'Zapněte nebo vypněte funkce a přizpůsobte si TripNest.',
  ...
  'admin.github.by': 'od',
  'admin.github.support': 'Pomáhá udržovat vývoj TripNest',

  // Počasí (Weather)
  'admin.weather.title': 'Data o počasí',
  'admin.weather.badge': 'Od 24. března 2026',
  'admin.weather.description': 'TripNest používá Open-Meteo jako zdroj dat. Je to bezplatná open-source služba – není vyžadován API klíč.',
  ...
  'admin.update.text': 'TripNest {version} je k dispozici. Aktuálně používáte verzi {current}.',
  ...
  'admin.update.confirmText': 'TripNest bude aktualizován z verze {current} na {version}. Server se poté automaticky restartuje.',
  ...
  'admin.update.dockerText': 'Váš TripNest běží v Dockeru. Pro aktualizaci na verzi {version} spusťte na svém serveru tyto příkazy:',
  ...
  'vacay.sharingHint': 'Sdílejte svůj plán dovolené s ostatními uživateli TripNest',
  'vacay.owner': 'Vlastník',
  'vacay.shareEmailPlaceholder': 'E-mail uživatele TripNest',
  ...
  'vacay.inviteHint': 'Pozvěte jiného uživatele TripNest ke sdílení společného kalendáře dovolených.',
