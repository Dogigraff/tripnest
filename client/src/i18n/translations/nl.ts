const nl: Record<string, string> = {
  ...
  'login.createAdminHint': 'Stel het eerste beheerdersaccount in voor TripNest.',
  ...
  'admin.addons.subtitle': 'Schakel functies in of uit om je TripNest-ervaring aan te passen.',
  ...
  'admin.weather.description': 'TripNest gebruikt Open-Meteo als weerbron. Open-Meteo is een gratis, open-source weerdienst — geen API-sleutel vereist.',
  ...
  'admin.github.support': 'Helpt mij TripNest verder te ontwikkelen',
  'admin.github.error': 'Releases laden mislukt',
  'admin.github.by': 'door',

  'admin.update.available': 'Update beschikbaar',
  'admin.update.text': 'TripNest {version} is beschikbaar. Je draait {current}.',
  'admin.update.button': 'Bekijk op GitHub',
  'admin.update.install': 'Update installeren',
  'admin.update.confirmTitle': 'Update installeren?',
  'admin.update.confirmText': 'TripNest wordt bijgewerkt van {current} naar {version}. De server herstart automatisch.',
  ...
  'admin.update.dockerText': 'Je TripNest-instantie draait in Docker. Om bij te werken naar {version}, voer de volgende commando\'s uit op je server:',
  ...
  'vacay.sharing': 'Delen',
  'vacay.sharingHint': 'Deel je vakantieplan met andere TripNest-gebruikers',
  'vacay.owner': 'Eigenaar',
  'vacay.shareEmailPlaceholder': 'E-mail van TripNest-gebruiker',
  ...
  'vacay.inviteHint': 'Nodig een andere TripNest-gebruiker uit om een gecombineerde vakantiekalender te delen.',
