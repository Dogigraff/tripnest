const de: Record<string, string | { name: string; category: string }[]> = {
  ...
  'admin.webhook.hint': 'Benachrichtigungen an einen externen Webhook senden (AureStudio, Slack usw.).',
  ...
  'login.createAdminHint': 'Erstelle das erste Admin-Konto für TripNest.',
  ...
  'admin.addons.subtitle': 'Aktiviere oder deaktiviere Funktionen, um TripNest nach deinen Wünschen anzupassen.',
  ...
  'admin.weather.description': 'TripNest nutzt Open-Meteo als Wetterdatenquelle. Open-Meteo ist ein kostenloser, quelloffener Wetterdienst — es wird kein API-Schlüssel benötigt.',
  ...
  'admin.github.by': 'von',
  'admin.github.support': 'Hilft mir, TripNest weiterzuentwickeln',

  'admin.update.available': 'Update verfügbar',
  'admin.update.text': 'TripNest {version} ist verfügbar. Du verwendest {current}.',
  ...
  'admin.update.confirmText': 'TripNest wird von {current} auf {version} aktualisiert. Der Server startet danach automatisch neu.',
  ...
  'admin.update.dockerText': 'Deine TripNest-Instanz läuft in Docker. Um auf {version} zu aktualisieren, führe folgende Befehle auf deinem Server aus:',
  ...
  'vacay.sharingHint': 'Teile deinen Urlaubsplan mit anderen TripNest-Benutzern',
  'vacay.owner': 'Besitzer',
  'vacay.shareEmailPlaceholder': 'E-Mail des TripNest-Benutzers',
  ...
  'vacay.inviteHint': 'Lade einen anderen TripNest-Benutzer ein, um einen gemeinsamen Urlaubskalender zu teilen.',
