const pl: Record<string, string | { name: string; category: string }[]> = {
  ...
  'login.createAdminHint': 'Skonfiguruj pierwsze konto administratora dla TripNest.',
  ...
  'admin.addons.subtitle': 'Włączaj lub wyłączaj funkcje, aby dostosować swoje doświadczenie w TripNest.',
  ...
  'admin.weather.description': 'TripNest korzysta z Open-Meteo jako źródła danych pogodowych. Open-Meteo to darmowy, otwartoźródłowy serwis pogodowy — klucz API nie jest wymagany.',
  ...
  'admin.github.support': 'Pomóż mi rozwijać TripNest',

  'admin.update.available': 'Dostępna aktualizacja',
  'admin.update.text': 'Dostępna jest wersja TripNest {version}. Używasz {current}.',
  ...
  'admin.update.confirmText': 'TripNest zostanie zaktualizowany z {current} do {version}. Serwer zostanie automatycznie zrestartowany po zakończeniu.',
  ...
  'admin.update.dockerText': 'Twoja instancja TripNest działa w Dockerze. Aby zaktualizować do {version}, uruchom następujące polecenia na swoim serwerze:',
  ...
  'vacay.sharingHint': 'Udostępnij swój plan urlopów innym użytkownikom TripNest',
  'vacay.owner': 'Właściciel',
  'vacay.shareEmailPlaceholder': 'E-mail użytkownika TripNest',
  ...
  'vacay.inviteHint': 'Zaproś innego użytkownika TripNest do wspólnego kalendarza urlopów.',
