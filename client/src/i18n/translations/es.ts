const es: Record<string, string> = {
  ...
  'admin.webhook.hint': 'Enviar notificaciones a un webhook externo (AureStudio, Slack, etc.).',
  ...
  'login.createAdminHint': 'Configura la primera cuenta administradora de TripNest.',
  ...
  'admin.addons.subtitle': 'Activa o desactiva funciones para personalizar tu experiencia en TripNest.',
  ...
  'admin.weather.description': 'TripNest utiliza Open-Meteo como fuente de datos meteorológicos. Open-Meteo es un servicio meteorológico gratuito y de código abierto: no requiere clave API.',
  ...
  'admin.github.support': 'Ayuda a seguir desarrollando TripNest',
  'admin.github.error': 'No se pudieron cargar las versiones',
  'admin.github.by': 'por',
  'admin.update.available': 'Actualización disponible',
  'admin.update.text': 'TripNest {version} está disponible. Estás usando {current}.',
  ...
  'admin.update.confirmText': 'TripNest se actualizará de {current} a {version}. Después, el servidor se reiniciará automáticamente.',
  ...
  'admin.update.dockerText': 'Tu instancia de TripNest se ejecuta en Docker. Para actualizar a {version}, ejecuta los siguientes comandos en tu servidor:',
  ...
  'vacay.sharingHint': 'Comparte tu calendario de vacaciones con otros usuarios de TripNest',
  'vacay.owner': 'Propietario',
  'vacay.shareEmailPlaceholder': 'Correo electrónico del usuario de TripNest',
  ...
  'vacay.inviteHint': 'Invita a otro usuario de TripNest a compartir un calendario combinado de vacaciones.',
