const zh: Record<string, string> = {
  ...
  'login.createAdminHint': '为 TripNest 设置第一个管理员账户。',
  ...
  'admin.addons.subtitle': '启用或禁用功能以自定义你的 TripNest 体验。',
  ...
  'admin.weather.description': 'TripNest 使用 Open-Meteo 作为天气数据源。Open-Meteo 是免费的开源天气服务——无需 API 密钥。',
  ...
  'admin.github.support': '帮助我继续开发 TripNest',
  'admin.github.error': '加载版本失败',
  'admin.github.by': '作者',

  'admin.update.available': '有可用更新',
  'admin.update.text': 'TripNest {version} 已发布。你当前使用的是 {current}。',
  'admin.update.button': '在 GitHub 查看',
  'admin.update.install': '安装更新',
  'admin.update.confirmTitle': '确定安装更新？',
  'admin.update.confirmText': 'TripNest 将从 {current} 更新到 {version}。服务器将自动重启。',
  ...
  'admin.update.dockerText': '你的 TripNest 实例运行在 Docker 中。要更新到 {version}，请在服务器上执行以下命令：',
  ...
  'vacay.sharing': '共享',
  'vacay.sharingHint': '与其他 TripNest 用户共享你的假期计划',
  'vacay.owner': '所有者',
  'vacay.shareEmailPlaceholder': 'TripNest 用户邮箱',
  ...
  'vacay.inviteHint': '邀请其他 TripNest 用户共享合并的假期日历。',
