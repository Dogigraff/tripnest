const fr: Record<string, string> = {
  ...
  'login.createAdminHint': 'Configurez le premier compte administrateur pour TripNest.',
  ...
  'admin.addons.subtitle': 'Activez ou désactivez des fonctionnalités pour personnaliser votre expérience TripNest.',
  ...
  'admin.weather.description': 'TripNest utilise Open-Meteo comme source de données météo. Open-Meteo est un service météo gratuit et open source — aucune clé API requise.',
  ...
  'admin.github.support': 'Aidez à poursuivre le développement de TripNest',
  'admin.github.error': 'Impossible de charger les versions',
  'admin.github.by': 'par',

  'admin.update.available': 'Mise à jour disponible',
  'admin.update.text': 'TripNest {version} est disponible. Vous utilisez {current}.',
  ...
  'admin.update.confirmText': 'TripNest sera mis à jour de {current} vers {version}. Le serveur redémarrera automatiquement ensuite.',
  ...
  'admin.update.dockerText': 'Votre instance TripNest fonctionne dans Docker. Pour mettre à jour vers {version}, exécutez les commandes suivantes sur votre serveur :',
  ...
  'vacay.sharingHint': 'Partagez votre plan de vacances avec d\'autres utilisateurs TripNest',
  'vacay.owner': 'Propriétaire',
  'vacay.shareEmailPlaceholder': 'E-mail de l\'utilisateur TripNest',
  ...
  'vacay.inviteHint': 'Invitez un autre utilisateur TripNest à partager un calendrier de vacances combiné.',
