const hu: Record<string, string | { name: string; category: string }[]> = {
  ...
  'login.createAdminHint': 'Hozd létre az első admin fiókot a TripNest-hez.',
  ...
  'admin.addons.subtitle': 'Funkciók engedélyezése vagy letiltása a TripNest testreszabásához.',
  ...
  'admin.weather.description': 'A TripNest az Open-Meteo-t használja időjárás-adatforrásként. Az Open-Meteo egy ingyenes, nyílt forráskódú időjárás-szolgáltatás — nincs szükség API kulcsra.',
  ...
  'admin.github.support': 'Segít fenntartani a TripNest fejlesztését',

  'admin.update.available': 'Frissítés elérhető',
  'admin.update.text': 'A TripNest {version} elérhető. Jelenleg a {current} verziót használod.',
  ...
  'admin.update.confirmText': 'A TripNest frissítésre kerül {current} verzióról {version} verzióra. A szerver ezután automatikusan újraindul.',
  ...
  'admin.update.dockerText': 'A TripNest példányod Dockerben fut. A {version} verzióra frissítéshez futtasd a következő parancsokat a szervereden:',
  ...
  'vacay.sharingHint': 'Szabadságterved megosztása más TripNest felhasználókkal',
  'vacay.owner': 'Tulajdonos',
  'vacay.shareEmailPlaceholder': 'TripNest felhasználó e-mail címe',
  ...
  'vacay.inviteHint': 'Hívj meg egy másik TripNest felhasználót közös szabadságnaptár megosztásához.',
