const ru: Record<string, string> = {
  ...
  'login.createAdminHint': 'Настройте первый аккаунт администратора для TripNest.',
  ...
  'admin.addons.subtitle': 'Включайте или отключайте функции для настройки TripNest под себя.',
  ...
  'admin.weather.description': 'TripNest использует Open-Meteo как источник данных о погоде. Open-Meteo — бесплатный сервис с открытым кодом, API-ключ не требуется.',
  ...
  'admin.github.support': 'Помогает продолжать разработку TripNest',
  'admin.github.error': 'Не удалось загрузить релизы',
  'admin.github.by': 'от',

  'admin.update.available': 'Доступно обновление',
  'admin.update.text': 'Доступна версия TripNest {version}. У вас установлена {current}.',
  ...
  'admin.update.confirmText': 'TripNest будет обновлён с {current} до {version}. Сервер перезапустится автоматически.',
  ...
  'admin.update.dockerText': 'Ваш экземпляр TripNest работает в Docker. Для обновления до {version} выполните следующие команды на сервере:',
  ...
  'vacay.sharingHint': 'Поделитесь планом отпуска с другими пользователями TripNest',
  'vacay.owner': 'Владелец',
  'vacay.shareEmailPlaceholder': 'Эл. почта пользователя TripNest',
  ...
  'vacay.inviteHint': 'Пригласите другого пользователя TripNest для совместного календаря отпусков.',
