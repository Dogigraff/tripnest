const it: Record<string, string | { name: string; category: string }[]> = {
  ...
  'login.createAdminHint': 'Imposta il primo account amministratore per TripNest.',
  ...
  'admin.addons.subtitle': 'Abilita o disabilita le funzionalità per personalizzare la tua esperienza TripNest.',
  ...
  'admin.weather.description': 'TripNest utilizza Open-Meteo come fonte dei dati meteo. Open-Meteo è un servizio meteo gratuito e open-source — non è richiesta alcuna chiave API.',
  ...
  'admin.github.by': 'da',
  'admin.github.support': 'Mi aiuta a continuare a sviluppare TripNest',

  'admin.update.available': 'Aggiornamento disponibile',
  'admin.update.text': 'TripNest {version} è disponibile. Stai eseguendo {current}.',
  ...
  'admin.update.confirmText': 'TripNest verrà aggiornato da {current} a {version}. Il server si riavvierà automaticamente in seguito.',
  ...
  'admin.update.dockerText': 'La tua istanza TripNest è in esecuzione in Docker. Per aggiornare alla versione {version}, esegui i seguenti comandi sul tuo server:',
  ...
  'vacay.sharingHint': 'Condividi il tuo piano ferie con altri utenti TripNest',
  'vacay.owner': 'Proprietario',
  'vacay.shareEmailPlaceholder': 'Email dell\'utente TripNest',
  ...
  'vacay.inviteHint': 'Invita un altro utente TripNest a condividere un calendario ferie combinato.',
