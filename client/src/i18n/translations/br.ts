const br: Record<string, string | { name: string; category: string }[]> = {
  ...
  'login.createAdminHint': 'Configure a primeira conta de administrador do TripNest.',
  ...
  'admin.addons.subtitle': 'Ative ou desative recursos para personalizar sua experiência no TripNest.',
  ...
  'admin.weather.description': 'O TripNest usa Open-Meteo como fonte de clima. Open-Meteo é um serviço gratuito e de código aberto — sem chave de API.',
  ...
  'admin.github.by': 'por',
  'admin.github.support': 'Ajuda a continuar desenvolvendo o TripNest',

  'admin.update.available': 'Atualização disponível',
  'admin.update.text': 'O TripNest {version} está disponível. Você está na {current}.',
  'admin.update.button': 'Ver no GitHub',
  'admin.update.install': 'Instalar atualização',
  'admin.update.confirmTitle': 'Instalar atualização?',
  'admin.update.confirmText': 'O TripNest será atualizado de {current} para {version}. O servidor reiniciará automaticamente em seguida.',
  ...
  'admin.update.dockerText': 'Sua instância TripNest roda no Docker. Para atualizar para {version}, execute no servidor:',
  ...
  'vacay.sharingHint': 'Compartilhe seu plano de férias com outros usuários do TripNest',
  'vacay.owner': 'Proprietário',
  'vacay.shareEmailPlaceholder': 'E-mail do usuário TripNest',
  ...
  'vacay.inviteHint': 'Convide outro usuário TripNest para compartilhar um calendário de férias combinado.',
