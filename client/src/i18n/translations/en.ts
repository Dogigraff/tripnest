const en: Record<string, string | { name: string; category: string }[]> = {
  ...
  'login.createAdminHint': 'Set up the first admin account for TripNest.',
  ...
  'admin.addons.subtitle': 'Enable or disable features to customize your TripNest experience.',
  ...
  'admin.weather.description': 'TripNest uses Open-Meteo as its weather data source. Open-Meteo is a free, open-source weather service — no API key required.',
  ...
  'admin.github.by': 'by',
  'admin.github.support': 'Helps me keep building TripNest',

  'admin.update.available': 'Update available',
  'admin.update.text': 'TripNest {version} is available. You are running {current}.',
  'admin.update.button': 'View on GitHub',
  'admin.update.install': 'Install Update',
  'admin.update.confirmTitle': 'Install Update?',
  'admin.update.confirmText': 'TripNest will be updated from {current} to {version}. The server will restart automatically afterwards.',
  ...
  'admin.update.dockerText': 'Your TripNest instance runs in Docker. To update to {version}, run the following commands on your server:',
  ...
  'vacay.sharingHint': 'Share your vacation plan with other TripNest users',
  'vacay.owner': 'Owner',
  'vacay.shareEmailPlaceholder': 'Email of TripNest user',
  ...
  'vacay.inviteHint': 'Invite another TripNest user to share a combined vacation calendar.',
