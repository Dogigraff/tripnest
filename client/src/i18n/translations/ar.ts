...
const ar: Record<string, string | { name: string; category: string }[]> = {
  ...
  'login.createAdminHint': 'أعد إعداد أول حساب مسؤول لـ TripNest.',
  ...
  'admin.addons.subtitle': 'فعّل أو عطّل الميزات لتخصيص تجربة TripNest.',
  ...
  'admin.weather.description': 'يستخدم TripNest خدمة Open-Meteo كمصدر لبيانات الطقس. وهي خدمة مجانية ومفتوحة المصدر ولا تتطلب مفتاح API.',
  ...
  'admin.github.support': 'يساعدني في تطوير TripNest',

  'admin.update.available': 'يتوفر تحديث',
  'admin.update.text': 'TripNest {version} متوفر. أنت تستخدم {current}.',
  'admin.update.button': 'عرض على GitHub',
  'admin.update.install': 'تثبيت التحديث',
  'admin.update.confirmTitle': 'تثبيت التحديث؟',
  'admin.update.confirmText': 'سيتم تحديث TripNest من {current} إلى {version}. سيُعاد تشغيل الخادم تلقائيًا بعد ذلك.',
  ...
  'admin.update.dockerText': 'يعمل TripNest الخاص بك في Docker. للتحديث إلى {version}، نفّذ الأوامر التالية على الخادم:',
  ...
  'vacay.sharingHint': 'شارك خطة إجازاتك مع مستخدمي TripNest الآخرين',
  'vacay.owner': 'المالك',
  'vacay.shareEmailPlaceholder': 'البريد الإلكتروني لمستخدم TripNest',
  ...
  'vacay.inviteHint': 'ادعُ مستخدم TripNest آخرًا لمشاركة تقويم إجازة مشترك.',
