...
<div class="pdf-footer">
  <span>made with</span>
  <img src="${absUrl('/logo-dark.png')}" style="height:10px;width:auto;opacity:0.6;" />
</div>
...
<div class="cover">
  ...
  <div class="cover-brand"><img src="${absUrl('/logo-light.png')}" style="height:28px;width:auto;opacity:0.5;" /></div>
