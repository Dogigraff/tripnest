    ...
    <nav style={{
      ...
      <div className="flex items-center gap-3 min-w-0">
        ...
        <Link to="/dashboard" className="flex items-center transition-colors flex-shrink-0">
          <img src={dark ? '/icons/icon-white.svg' : '/icons/icon-dark.svg'} alt="TripNest" className="sm:hidden" style={{ height: 22, width: 22 }} />
          <img src={dark ? '/logo-light.png' : '/logo-dark.png'} alt="TripNest" className="hidden sm:block" style={{ height: 28, width: 'auto' }} />
        </Link>
