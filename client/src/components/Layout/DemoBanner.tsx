...
const texts: Record<string, DemoTexts> = {
  de: {
    ...
    titleAfter: '',
    title: 'Willkommen zur TripNest Demo',
  ...
  en: {
    ...
    titleAfter: '',
    title: 'Welcome to the TripNest Demo',
  ...
  es: {
    ...
    titleAfter: '',
    title: 'Bienvenido a la demo de TripNest',
  ...
  ar: {
    ...
    titleAfter: '',
    title: 'مرحبًا بك في النسخة التجريبية من TripNest',
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 14 }}>
          ...
          <h2 style={{ margin: 0, fontSize: 17, fontWeight: 700, color: '#111827', display: 'flex', alignItems: 'center', gap: 5 }}>
            {t.titleBefore}<img src="/text-dark.png" alt="TripNest" style={{ height: 18, width: 'auto' }} />{t.titleAfter}
          </h2>
        </div>
