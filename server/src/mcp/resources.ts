...
export function registerResources(server: McpServer, userId: number): void {
  ...
  server.registerResource(
    'trip',
    new ResourceTemplate('tripnest://trips/{tripId}', { list: undefined }),
  ...
  server.registerResource(
    'trip-days',
    new ResourceTemplate('tripnest://trips/{tripId}/days', { list: undefined }),
  ...
  server.registerResource(
    'trip-places',
    new ResourceTemplate('tripnest://trips/{tripId}/places', { list: undefined }),
  ...
  server.registerResource(
    'trip-budget',
    new ResourceTemplate('tripnest://trips/{tripId}/budget', { list: undefined }),
  ...
  server.registerResource(
    'trip-packing',
    new ResourceTemplate('tripnest://trips/{tripId}/packing', { list: undefined }),
  ...
  server.registerResource(
    'trip-reservations',
    new ResourceTemplate('tripnest://trips/{tripId}/reservations', { list: undefined }),
  ...
  server.registerResource(
    'day-notes',
    new ResourceTemplate('tripnest://trips/{tripId}/days/{dayId}/notes', { list: undefined }),
  ...
  server.registerResource(
    'trip-accommodations',
    new ResourceTemplate('tripnest://trips/{tripId}/accommodations', { list: undefined }),
  ...
  server.registerResource(
    'trip-members',
    new ResourceTemplate('tripnest://trips/{tripId}/members', { list: undefined }),
  ...
  server.registerResource(
    'trip-collab-notes',
    new ResourceTemplate('tripnest://trips/{tripId}/collab-notes', { list: undefined }),
